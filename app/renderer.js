...
const PY_MODULE = "server.py"; // the name of the main module
...
const createMainWindow = () => {
  ...
  // Load the index page
  mainWindow.loadURL("http://localhost:5073/");
...
app.on("ready", function () {
  ...
  createSplash();
    setTimeout(()=>{
    splashWin.hide()       // Hide Splash

    // start the backend server
    startPythonSubprocess();
    createMainWindow();
    
    splashWin.destroy()    // Splash removal
  }, 1500)
