...
class ToppingAutoCalset(object):
    ...
    def task_motion(self, hCtrl, HTask_name :str):
    ...
    def topping_calset(self):
        ...
        try:
            ...
            self.task_motion(hCtrl, "sales/global_init")
...
if __name__ == '__main__':
        robot = ToppingAutoCalset()
        robot.topping_calset()